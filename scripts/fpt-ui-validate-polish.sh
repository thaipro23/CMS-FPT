...
.fpt-lms-footer__logo{width:228px;max-height:66px;object-fit:contain;object-position:left center}.fpt-lms-footer__tag{margin-top:7px;color:#7A899C;font-size:13px;font-weight:650}
.fpt-lms-footer__copy{max-width:1340px;margin:0 auto;border-top:1px solid #E8EDF3;padding:18px 28px 24px;text-align:center;color:#8492A4;font-size:12px}
...
expected_courses = [
    ...
    '.fpt-slide__cta:hover{background:#B94700',
]
...
if 'color:#F36F21;font-size:11px' in courses or 'background:#F36F21;color:#fff!important' in courses:
    raise SystemExit('low-contrast Hero text/CTA styling remains after polish')
...
legacy_layout_markers = [
    ...
    '.fpt-lms-footer__tag{margin-top:7px;color:#65758A',
    'text-align:center;color:#65758A;font-size:12px',
]
...
runtime_layout_markers = [
    ...
    '.fpt-ui-footer__tagline{margin-top:7px;color:#65758A',
    '.fpt-ui-footer__copyright{border-top:1px solid #E8EDF3;margin-top:30px;padding-top:18px;color:#65758A',
    '.fpt-learner-banner__eyebrow{color:#C94E08',
]
for marker in runtime_layout_markers:
    if marker not in runtime:
        raise SystemExit(f'balanced MFE responsive/contrast marker missing: {marker}')
...
print('[fpt-ui-polish] Accessibility/layout/contrast fixture PASS')
PY
