...
grep -R -Fq "FPT Polytechnic V12 white-logo dark-surface contract" "$MFE_VERIFY_DIR/authn" || fail "Compiled Authn is missing the V12 white-logo/dark-surface contract"
