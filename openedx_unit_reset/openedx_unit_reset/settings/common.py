...
OPENEDX_UNIT_RESET_PLUGIN_VERSION = '0.4.14.5'
...
def plugin_settings(settings):
    ...
    settings.OPENEDX_UNIT_RESET_PLUGIN_VERSION = getattr(
        settings,
        "OPENEDX_UNIT_RESET_PLUGIN_VERSION",
        OPENEDX_UNIT_RESET_PLUGIN_VERSION,
    )
    settings.UNIT_RESET_QUIZ_TIMER_SUBMIT_BUTTON_ONLY = getattr(
        settings,
        "UNIT_RESET_QUIZ_TIMER_SUBMIT_BUTTON_ONLY",
        UNIT_RESET_QUIZ_TIMER_SUBMIT_BUTTON_ONLY,
    )
    settings.UNIT_RESET_QUIZ_TIMER_LOCK_COOLDOWN_FROM_EXPIRES_AT = getattr(
        settings,
        "UNIT_RESET_QUIZ_TIMER_LOCK_COOLDOWN_FROM_EXPIRES_AT",
        UNIT_RESET_QUIZ_TIMER_LOCK_COOLDOWN_FROM_EXPIRES_AT,
    )
    settings.UNIT_RESET_QUIZ_TIMER_RUNTIME_LOCK_DELAY_MS = getattr(
        settings,
        "UNIT_RESET_QUIZ_TIMER_RUNTIME_LOCK_DELAY_MS",
        UNIT_RESET_QUIZ_TIMER_RUNTIME_LOCK_DELAY_MS,
    )
